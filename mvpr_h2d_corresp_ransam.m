...
%
%%
function [bestH bestXt bestParams] = mvpr_h2d_corresp_ransam(X1_,X2_,tType_,iNum_,bestUsed_,varargin)
...
for iterInd = 1:iNum_
	...
	case 1,
		...
		if (mvpr_h2d_corresp_isvalid(rX1, rX2, 1))
			[H theta tx ty] = ...
			       mvpr_h2d_corresp_exiso(rX1, rX2);
		else
			theta = 0;
			tx = 0;
			ty = 0;
	...
	case 2,
		...
		if (mvpr_h2d_corresp_isvalid(rX1, rX2, 2))
			[H theta tx ty s] = ...
                            mvpr_h2d_corresp_exsim(rX1, rX2);
                else
			theta = 0;
			tx = 0;
			ty = 0;
	...
	case 3,
		...
		[H theta tx ty delta1 delta2 beta] = ...
                    mvpr_h2d_corresp_exaff(rX1, rX2);
...
case 1,
	...
	bestH = mvpr_h2d_iso(theta, [tx ty]);
...
bestXt = mvpr_h2d_trans(X1_,bestH)';
