%MVPR_SG_CREATEFILTERBANK Creates Gabor filter bank
% 
...
%
% See also MVPR_SG_FILTERWITHBANK.M .
%
function [bank]=mvpr_sg_createfilterbank(N, f, m, n, varargin)
...
if maxfactor>13
  warning('sg_createfilterbank:largeDimensionFactor','sg_createfilterbank: FFT computations might be slow, largest factor of image dimensions is %d', maxfactor);
end;
...
if conf.domain==1
  ...
  for f0=freq,
    ...
    for o0=orientation,
      [filt,envelope,fhigh]=mvpr_sg_createfilterf2(f0,o0,conf.gamma,conf.eta,N,'use_envelope',1,'pf',conf.pf);
