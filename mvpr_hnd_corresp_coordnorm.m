...
%
% [nX1 nX2 Un Tn] = mvpr_hnd_corresp_coordnorm(X1_,X2_,nm_)
%
...
%
% See also MVPR_HND_CORRESP_COORDDENORM.M and MVPR_H2D_CORRESP_DLT.M
%
function [nX1 nX2 Un Tn] = mvpr_hnd_corresp_coordnorm(X1_,X2_,nm_)
