%MVPR_H2D_CORRESP_EXAFF Exact 2-D homography (affinity) from point
%correspondence
%
% [H,theta,tx,ty,delta1,delta2,phi] = mvpr_h2d_corresp_exaff(X1_,X2_)
%
...
function [H, theta, tx, ty, delta1, delta2, phi] = ...
                                 mvpr_h2d_corresp_exaff(X1_,X2_)
