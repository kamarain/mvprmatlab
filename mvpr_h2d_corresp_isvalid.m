%MVPR_H2D_CORRESP_ISVALID Checks if the given point set is valid
%for estimating the specific homography
%
% [v] = mvpr_h2d_corresp_isvalid(X1_,X2_,h_,:)
%
...
% MVPR_H2D_CORRESP_RANSAM.M since it would collapse if the underlying
...
%
% See also MVPR_H2D_CORRESP_EX*.M
%
function [v] = mvpr_h2d_corresp_isvalid(X1_,X2_,h_)
