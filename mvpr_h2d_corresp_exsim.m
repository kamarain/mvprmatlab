%MVPR_H2D_CORRESP_EXSIM Exact 2-D homography (similarity) from point
%correspondence
%
% [H,theta,tx,ty,s] = mvpr_h2d_corresp_exsim(X1_,X2_)
%
...
%
function [H,theta,tx,ty,s] = mvpr_h2d_corresp_exsim(X1_,X2_)
