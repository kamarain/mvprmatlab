%MVPR_H2D_PRO Construct 2-D homography matrix (projectivity)
%
% [H] = mvpr_h2d_pro(theta_,t_,delta1_,delta2_,phi_,v1_,v2_,v)
%
% Output:
...
%%
function [H] = mvpr_h2d_pro(theta_,t_,delta1_,delta2_,phi_,v1_,v2_,v_);
