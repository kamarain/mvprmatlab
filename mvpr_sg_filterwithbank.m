%MVPR_SG_FILTERWITHBANK - Gabor filtering with filterbank
%
...
%
% See also MVPR_SG_FILTEWITHBANK2.M, SG_CREATEFILTERBANK and
% SG_RESP2SAMPLEMATRIX .
%
function [m]=mvpr_sg_filterwithbank(s, bank, varargin)
