...
Concerns functions with "mvpr_sg_" prefix (used to be "sg_")


Changelog
---------

Version 1.0.0-mvpr (re-located)
  Moved under CVS:simplegabor/src/matlab/base2 to SVN:mvprmatlab/trunk
  and renamed functions with "mvpr_" prefix - all further development
  and bug fixes should be done in the new location.
